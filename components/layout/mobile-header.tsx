  ...
  return (
    <header className={cn("sticky top-0 z-30 flex h-20 items-center justify-between bg-background/90 px-5 backdrop-blur", className)}>
      ...
      {action === "create" ? (
        ...
        <Link href="/profile" className="grid h-11 w-11 place-items-center rounded-full border border-border bg-primary-soft font-serif text-xl text-primary">A</Link>
      ) : (
