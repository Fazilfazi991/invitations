  ...
  return (
    <div className="mt-5 rounded-2xl border border-border bg-white/75 p-3">
      <p className="mb-3 text-xs font-bold uppercase tracking-[0.18em] text-brand-violet">
        {state.passed ? "Thank you for joining us" : "Countdown to celebration"}
      </p>
      {state.passed && <p className="mb-3 font-serif text-2xl font-bold text-primary">The celebration has begun</p>}
