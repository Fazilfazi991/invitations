    ...
    <TemplateShell background="#FFF7F6">
      ...
      <div className="space-y-5 px-5 pb-6">
        <section className="rounded-t-full border border-border bg-white/80 p-6 text-center shadow-card">
          ...
          <h1 className="mt-4 font-serif text-[clamp(2.4rem,10vw,3.75rem)] font-bold leading-[0.98] [overflow-wrap:anywhere]" style={{ color: primary }}>{bride ? <>{groom}<span className="block text-2xl">&</span>{bride}</> : coupleName}</h1>
