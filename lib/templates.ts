...
export const weddingTemplates: EventTemplate[] = [
  {
    ...
    name: "Floral Luxury Wedding",
    category: "wedding",
    description: "A luxurious floral wedding design with refined serif type, RSVP, countdown, gallery and location sections.",
  ...
  },
  {
    ...
    name: "Classic Royal Wedding",
    category: "wedding",
    description: "A classic royal wedding template with ceremonial arches, soft gold details and a polished family-first layout.",
  ...
  },
  {
    ...
    name: "Minimal Elegant Wedding",
    category: "wedding",
    description: "An elegant minimal wedding template with generous white space, crisp typography and restrained lavender accents.",
  ...
  },
  {
    ...
    category: "wedding",
    description: "A warm traditional Indian wedding template with family details, ceremonial schedule, RSVP and gallery sections.",
  ...
  },
  {
    ...
    name: "Modern Premium Wedding",
    category: "wedding",
    description: "A modern premium wedding template with a photo-forward hero, clean sections, countdown, RSVP and location actions.",
